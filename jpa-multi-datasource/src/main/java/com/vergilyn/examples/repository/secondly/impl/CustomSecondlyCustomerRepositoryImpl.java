package com.vergilyn.examples.repository.secondly.impl;

import java.util.Map;

import com.google.common.collect.Maps;
import com.vergilyn.examples.entity.Customer;
import com.vergilyn.examples.repository.secondly.CustomSecondlyCustomerRepository;
 ...
 * @date 2019-03-21
 */
public class CustomSecondlyCustomerRepositoryImpl implements CustomSecondlyCustomerRepository {
    @Autowired
    @Qualifier("secondlyJdbcTemplate")
    private JdbcTemplate jdbcTemplate;
    @Autowired
    @Qualifier("secondlyNamedJdbcTemplate")
